...
import 'package:flutter_ui/animation/animated_widget/decorated_box_transition_page.dart';
...
import 'package:flutter_ui/animation/animated_widget/slide_transition_page.dart';
              ...
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const DecoratedBoxTransitionPage(),
                    ),
                  );
                },
