...
import 'package:flutter_ui/mult_child/wrap_spacing_page.dart';
              ...
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const WrapSpacingPage(),
                    ),
                  );
                },
                child: const Text("Wrap spacing"),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 10),
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const StackAlignmentPage(),
                    ),
                  );
                },
              ...
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const StackFitPage(),
                    ),
                  );
                },
                child: const Text("Stack fit"),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 10),
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const StackOverflowPage(),
                    ),
                  );
                },
