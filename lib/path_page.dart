...
import 'package:flutter_ui/path/path_combine_page.dart';
              ...
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const PathCombinePage(),
                    ),
                  );
                },
                child: const Text("path Combine"),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 10),
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const PathMetricsPage(),
                    ),
                  );
                },
